...
const ProjectItem = ({
  ...
  return (
    <div {...interactionProps} className="h-12">
      <div className="rounded-2xl flex justify-between items-center cursor-default w-full xl:px-4 py-3 gap-8 hover:shadow-light hover:bg-gray-100 hover:scale-110 duration-500">
